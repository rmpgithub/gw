...
<html lang="pl">
<head>
    <title>Giełda Wschód 2022 </title>
    <!-- test rmpgit -->
...
<!--     <script src="https://cdnjs.cloudflare.com/ajax/lib/s/simplelightbox/1.11.1/simple-lightbox.js"></script>-->
    ...
    fbq('init', '280511320691564');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=280511320691564&ev=PageView&noscript=1"
    /></noscript>
...
<header class="container main-header">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-auto pt-3 pt-sm-0 d-flex flex-column justify-content-center align-items-center align-content-sm-start">
            <h3 class="heading-3">W KAŻDY PIĄTEK SOBOTĘ NIEDZIELĘ  <br> SKOŁOSZÓW </h3>
